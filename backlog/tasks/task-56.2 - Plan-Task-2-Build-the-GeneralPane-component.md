...
New apps/tauri/src/components/general-pane.tsx using only shadcn primitives. Three sections: Startup (placeholder Switch), Appearance (Theme stub ToggleGroup), About (live core_version readout). Local-state-only for placeholder rows.
...
- [ ] #3 About row fetches core_version via invoke and renders in font-mono
